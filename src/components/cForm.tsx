          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              <Select
                ...
                placeholder="Carrera"
                onChange={(value) =>
                  setFormValues({ ...formValues, select1: value })
                }
              >
              ...
              <Input
                ...
                required
                onChange={(event) =>
                  setFormValues({ ...formValues, input1: event.target.value })
                }
              />
              <Select
                ...
                placeholder="A"
                onChange={(value) =>
                  setFormValues({ ...formValues, select2: value })
                }
              >
              ...
              <Input
                ...
                placeholder="2"
                onChange={(event) =>
                  setFormValues({ ...formValues, input2: event.target.value })
                }
              />
              <Input
                style={{
              ...
              <Select
                ...
                placeholder="Carrera"
                onChange={(value) =>
                  setFormValues({ ...formValues, select3: value })
                }
              >
                <Select.Option value="Calle">Calle</Select.Option>
                <Select.Option value="Carrera">Carrera</Select.Option>
              ...
              <Input
                ...
                required
                onChange={(event) =>
                  setFormValues({ ...formValues, input3: event.target.value })
                }
              />
              <Select
                style={{ width: 70, marginRight: 4 }}
                placeholder="B"
                onChange={(value) =>
                  setFormValues({ ...formValues, select4: value })
                }
              >
                <Select.Option value=""> </Select.Option>
                <Select.Option value="A">A</Select.Option>
              ...
              <Input
                ...
                placeholder="11"
                onChange={(event) =>
                  setFormValues({ ...formValues, input4: event.target.value })
                }
              />
              <Input
                style={{
              ...
              <Input
                ...
                required
                onChange={(event) =>
                  setFormValues({ ...formValues, input5: event.target.value })
                }
              />
            </div>
          </Form.Item>
